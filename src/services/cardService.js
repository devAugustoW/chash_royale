...
export const getTopDecks = async (startDate, endDate, winrateThreshold) => {
  try {
...
export const getVictoriesWithLessCrowns = async (cardId, trophyDisadvantage, maxBattleDuration, towersDestroyed) => {
  try {
